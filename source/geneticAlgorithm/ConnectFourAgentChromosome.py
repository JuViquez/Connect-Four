...
class ConnectFourAgentChromosome(ConnectFourAgent, Chromosome):
    ...
    def mutate(self):
        ...
        self.strategies_probs = self.rand_provider.scale_probs(
            self.strategies_probs)
    ...
    def cross(self, chromosome):
        ...
        new_chromosome = ConnectFourAgentChromosome(
            self.disc, self.rand_provider, self.strategy, new_probs)
